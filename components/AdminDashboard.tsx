...
const AdminDashboard: React.FC<AdminDashboardProps> = ({ lang, onBack }) => {
  ...
  return (
    <div className="max-w-7xl mx-auto animate-fade-in-up pb-20 px-4 sm:px-6">
          ...
          <div className="space-y-8 animate-fade-in">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="bg-white dark:bg-gray-800 p-8 rounded-[2.5rem] border border-gray-100 dark:border-gray-700 shadow-sm relative overflow-hidden group">
                      <div className="absolute top-0 right-0 p-6 opacity-10 group-hover:scale-110 transition-transform"><TrendingUp className="w-16 h-16 text-emerald-500" /></div>
                      ...
                      <p className="text-xs text-emerald-500 font-bold mt-4 flex items-center gap-1"><TrendingUp className="w-3 h-3" /> +12% from last month</p>
                  </div>
                  ...
                  <div className="bg-white dark:bg-gray-800 p-8 rounded-[2.5rem] border border-gray-100 dark:border-gray-700 shadow-sm group">
                      ...
                      <h3 className="text-4xl font-black text-gray-900 dark:text-white font-mono">$120/mo</h3>
                      <p className="text-xs text-rose-500 font-bold mt-4">GPU & API Overheads</p>
                  </div>
              </div>
              ...
              <div className="grid lg:grid-cols-12 gap-8">
                  <div className="lg:col-span-8 bg-white dark:bg-gray-800 rounded-[2.5rem] border border-gray-100 dark:border-gray-700 shadow-sm overflow-hidden">
                      ...
                      <div className="overflow-x-auto">
                          {isFinancialLoading ? (
                              ...
                              <div className="p-20 text-center text-gray-400 italic">No transactions found in local buffer.</div>
                          ) : (
                              <table className="w-full">
                  ...
                  <div className="lg:col-span-4 space-y-6">
                                  ...
                                  return (
                                      <div key={tierId}>
                                          <div className="flex justify-between items-center mb-2">
                                              ...
                                              <span className="text-xs font-bold text-gray-400">{count} donors</span>
                                          </div>
                                          <div className="w-full h-2 bg-gray-100 dark:bg-gray-700 rounded-full overflow-hidden">
                                              <div 
                                                className={`h-full rounded-full transition-all duration-1000 ${tierId === 'mythic' ? 'bg-fuchsia-500' : tierId === 'diamond' ? 'bg-cyan-500' : tierId === 'platinum' ? 'bg-indigo-500' : tierId === 'gold' ? 'bg-yellow-500' : tierId === 'silver' ? 'bg-slate-400' : 'bg-amber-700'}`}
                      ...
                      <div className="bg-indigo-600 rounded-[2.5rem] p-8 text-white relative overflow-hidden shadow-xl">
                          ...
                          <h4 className="text-lg font-bold mb-4">Financial Health</h4>
                          <p className="text-sm text-indigo-100 leading-relaxed mb-6 italic">Gegenisht is currently 75% community-funded. Scaling to mythic tiers will enable dedicated archival storage.</p>
                          <div className="flex justify-between items-center bg-white/10 p-4 rounded-2xl border border-white/20">
                             ...
                             <span className="text-2xl font-black">9.4/10</span>
                          </div>
                      </div>
                  </div>
              </div>
      ...
      {(activeTab === 'shop' || activeTab === 'contributions' || activeTab === 'users') && (
