...
const translations = {
  eng: {
    ...
    std_desc: "The Unified Standard was established in 1972 by the Congress of Orthography, largely based on the Tosk dialect, suppressing Geg literary tradition.",
  ...
  geg: {
    ...
    std_desc: "Standardi i Unifikuem u vendos në vitin 1972 nga Kongresi i Drejtshkrimit, bazuem kryesisht në dialektin toskë, tuj shtypë traditën letrare gege.",
